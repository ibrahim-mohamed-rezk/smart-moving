      ...
      <section className="text-center py-[clamp(2rem,6vw,4rem)] container mx-auto">
        ...
        <div className="flex items-center flex-wrap justify-center gap-y-[clamp(30px,4vw,100px)] gap-x-[clamp(20px,2vw,100px)] mt-[clamp(50px,5.208vw,300px)] mx-auto">
          {services.map((service: ServiceTypes, idx: number) => (
            ...
            >
              <div className="w-full h-full px-[clamp(5px,1.667vw,132px)] bg-zinc-100 rounded-2xl shadow-[8px_8px_16px_0px_rgba(0,0,0,0.16)] flex flex-col justify-center items-center gap-[clamp(10px,1.667vw,32px)] transition-all duration-300 hover:bg-[#0E172F]">
                <div className="self-stretch flex flex-col justify-center items-center gap-3 sm:gap-4">
                  <div className="text-blue-950 text-[clamp(18px,1.875vw,36px)] font-bold font-['Libre_Baskerville'] capitalize transition-colors group-hover:text-white hover:text-white">
                    {service.title}
                  </div>
                  <div className="self-stretch text-center text-black/60 text-[clamp(14px,1.042vw,22px)] font-bold font-['Libre_Baskerville'] transition-colors group-hover:text-white/70 hover:text-white/70">
                    {service.description}
                  </div>
                </div>
                <div className="p-[clamp(5px,0.833vw,30px)] bg-white rounded-[100px] inline-flex justify-center items-center transition-colors hover:bg-white">
                  <div className="w-[clamp(50px,3.5vw,80px)] h-[clamp(50px,3.5vw,80px)] relative flex items-center justify-center">
                    <svg
              ...
              <div className="w-[clamp(50px,5.0vw,100px)] -translate-y-1/2 h-[clamp(50px,5.0vw,100px)] p-[clamp(5px,0.833vw,30px)] absolute left-1/2 top-0 transform translate-x-[-50%] bg-zinc-100 rounded-[100px] shadow-[10px_10px_14px_0px_rgba(0,0,0,0.16)] flex flex-col justify-center items-center">
