...
const MovingInfoPage = () => {
  ...
  return (
      <div className="flex flex-col min-h-screen bg-gray-50" >
          ...
          {/* Content */}
          <main className="w-full max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 py-12 text-right">
              <div className="bg-white rounded-2xl shadow p-6 sm:p-8 text-[16px] sm:text-[18px] leading-8 whitespace-pre-wrap text-gray-800">
