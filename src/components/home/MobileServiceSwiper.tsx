  ...
  return (
    ...
    >
      {services.map((service, idx) => (
        <SwiperSlide
          key={idx}
          className="py-10 w-[clamp(250px,22.042vw,450px)] max-w-[250px] "
        >
...
const ServiceCard = ({ service, idx }:{ service: ServiceTypes, idx: number}) => {
  return (
    <Link
      ...
      className="relative group flex flex-col items-center justify-center w-[clamp(250px,22.042vw,450px)] h-[clamp(250px,20.438vw,400px)]"
    >
